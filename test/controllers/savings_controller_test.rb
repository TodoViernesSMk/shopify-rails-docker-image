...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post savings_url, params: { saving: { saving_value: @saving.saving_value, user: @saving.user, week: @saving.week } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { saving_value: @saving.saving_value, user: @saving.user, week: @saving.week } }
